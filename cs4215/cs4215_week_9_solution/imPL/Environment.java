...
public class Environment extends Hashtable<String,Integer> implements Value {
   ...
   public String toString() {
	      ...
	      for (; keys.hasMoreElements();) { 
	    	     String nextProperty = keys.nextElement();
	    	     s = s + nextProperty + " : " + get(nextProperty);
	    	     if (keys.hasMoreElements()) s = s + ',';
	      }
		  s = s + "]";
	      return s;
	  }
